...
1. Audio-level driven waveform — replace shimmer with real RMS levels
...
2. Idle collapse — pill shrinks after inactivity
...
3. Draggable pill position + persistence
...
4. Smooth width transitions between states
...
5. Haptic/sound feedback on button press
