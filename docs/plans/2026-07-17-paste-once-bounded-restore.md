...
4. Request CodeRabbit, Codex, and Cursor/Bugbot reviews; address event-ordering findings test-first, including modifier release before F5 key-up, independent F5/F18 pairings, and Shift acquired during an ordinary hold; and confirm the latest required checks.
