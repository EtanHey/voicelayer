...
const server = new Server(
  ...
  },
  {
    ...
    instructions:
      ...
      `- voice_ask(message): BLOCKING. Waits for any playing voice_speak audio to finish, then speaks question, collects input via configured backend, returns transcription. Local input supports touch ${STOP_FILE} OR 2.5s silence (thoughtful default).\n` +
