...
- Launchd keeps the daemon alive while `/tmp/.voicelayer-daemon-disabled` is absent; that covers crashes and clean exits without restart loops during explicit disable.
